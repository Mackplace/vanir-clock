...
for (i = 0; i < week.length; i++) {
    ...
    for (j = 0; j < week[i].length; j++) {
        ...
        clockGroupWeek.append('path')
            ...
            .attr("intervalo",week[i][j].intervalo)
...
clockGroupWeek.append("svg:circle")
    .attr("r", (radius+120)*(1-((week.length)*0.1)))
    .attr("fill", "white")
    .attr("class", "clock outercircle")
    .attr("stroke", "black")
    .attr("stroke-opacity", .3)
...
clockGroupWeek.selectAll('.minuteLabel')
...
var text0 = clockGroupWeek.append("text")
    .attr("class", "title")
    .attr('transform', 'translate(-300,-90)')
    .attr("x", w - 204)
    .attr("y", 35)
...
var text1 = clockGroupWeek.append("text")
    .attr("class", "title")
    .attr('transform', 'translate(-300,-90)')
    .attr("x", w-140 )
    .attr("y", 95)
...
var text2 = clockGroupWeek.append("text")
    .attr("class", "title")
    .attr('transform', 'translate(-300,-90)')
    .attr("x", w-210 )
    .attr("y", 155)
